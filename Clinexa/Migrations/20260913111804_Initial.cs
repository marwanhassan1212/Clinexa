        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Doctors_ConsultationFee_NonNegative", "[ConsultationFee] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Appointments_EndTime_After_StartTime", "[EndTime] > [StartTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DoctorScheduleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DayOfWeek = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    StartTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    EndTime = table.Column<TimeSpan>(type: "time", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DoctorSchedules_EndTime_After_StartTime", "[EndTime] > [StartTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceStatus = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Invoices_Amounts_NonNegative", "[SubTotal] >= 0 AND [Discount] >= 0 AND [Tax] >= 0 AND [TotalAmount] >= 0 AND [PaidAmount] >= 0 AND [RemainingAmount] >= 0");
                    table.CheckConstraint("CK_Invoices_PaidAmount_NotGreaterThanTotal", "[PaidAmount] <= [TotalAmount]");
                    table.CheckConstraint("CK_Invoices_RemainingAmount_Valid", "[RemainingAmount] = [TotalAmount] - [PaidAmount]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InvoiceItems_Prices_NonNegative", "[UnitPrice] >= 0 AND [TotalPrice] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceNumber = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Frequency = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Duration = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AppointmentDate_DoctorId_StartTime",
                table: "Appointments",
                columns: new[] { "AppointmentDate", "DoctorId", "StartTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AppointmentDate_PatientId_StartTime",
                table: "Appointments",
                columns: new[] { "AppointmentDate", "PatientId", "StartTime" },
                unique: true);
